...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/yermem/clxlzu2t200gv01qr1zi686a0',
  ...
  locations.forEach(function (locations) {
    ...
    new mapboxgl.Popup(popupOptions).setLngLat(locations.coordinates).setHTML("<p>Day ".concat(locations.day, ": ").concat(locations.description, "</p>")).addTo(map);
