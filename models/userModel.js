...
const userSchema = mongoose.Schema(
    {
        ...
        password:{
            type: String,
            required: true,
            maxlength: [80, 'A user name must have less or equal then 80 characters'],
            minlength: [4, 'A user name must have more or equal then 8 characters'],
            select: false
        },
        passwordConfirm:{
            type: String,
            ...
            validate: {
                ...
                message:"Input passwords did'nt match"
            }
        },
        passwordChangedAt: {
            type: Date
